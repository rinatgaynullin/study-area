...
// Разметку строит ядро; компоненту нужна только точка монтирования. В шаблоне
// нет комментариев намеренно: рядом с корневым элементом они делают компонент
// фрагментом, и класс с хоста перестаёт проваливаться на корень.
</script>
