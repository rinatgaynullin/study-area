...
const requireDom = (): Window & typeof globalThis => {
...
const getHtmlPurifier = (): Purifier => {
...
const getMathmlPurifier = (): Purifier => {
 ...
 */
export const sanitizeMathML = (mathml: string): string => {
  if (!mathml) return '';
...
export const resetSanitizers = (): void => {
  htmlPurifier = null;
  mathmlPurifier = null;
  svgPurifier = null;
};
